...
<nav class="pc-sidebar ">
    <div class="navbar-wrapper">
        <div class="m-header" >
            <a href="<?=site_url('admin')?>" class="b-brand">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="<?=site_url('admin')?>" class="pc-link "><span class="pc-micon"><i data-feather="home"></i></span><span class="pc-mtext">Dashboard</span><span class="pc-arrow"></span></a>
                </li>
                 <li class="pc-item">
                    <a href="<?=site_url('admin/view/slider')?>" class="pc-link"><span class="pc-micon"><i class="fa fa-images"></i></span><span class="pc-mtext">Slider</span></a>
                </li>
				<li class="pc-item">
                    <a href="<?=site_url('admin/view/employees')?>" class="pc-link"><span class="pc-micon"><i class="fa fa-users"></i></span><span class="pc-mtext">Employees</span></a>
                </li>
                
                <li class="pc-item">
                    <a href="<?=site_url('admin/view/users')?>" class="pc-link"><span class="pc-micon"><i class="fa fa-user-circle"></i></span><span class="pc-mtext">Users</span></a>
                </li>

                <li class="pc-item">
                    <a href="<?=site_url('admin/view/')?>products" class="pc-link"><span class="pc-micon"><i class="fa fa-cart-plus"></i></span><span class="pc-mtext">Products</span></a>
                </li>
				<li class="pc-item">
                    <a href="<?=site_url('admin/view/')?>categories" class="pc-link"><span class="pc-micon"><i class="fa fa-list-alt"></i></span><span class="pc-mtext">Categories</span></a>
                </li>
				<li class="pc-item">
                    <a href="<?=site_url('admin/view/')?>plan" class="pc-link"><span class="pc-micon"><i class="fa fa-cart-plus"></i></span><span class="pc-mtext">Plans</span></a>
                </li>

                <li class="pc-item">
                    <a href="<?=site_url('admin/view/order')?>" class="pc-link"><span class="pc-micon"><i class="fa fa-file-invoice-dollar mr-1"></i></span><span class="pc-mtext">Orders</span></a>
                </li>


                <li class="pc-item">
                    <a href="<?=site_url('admin/view/coupons')?>" class="pc-link"><span class="pc-micon"><i class="fa fa-gift"></i></span><span class="pc-mtext">Coupons</span></a>
                </li>
				<li class="pc-item">
                    <a href="<?=site_url('admin/view/stripe')?>" class="pc-link"><span class="pc-micon"><i class="fa fa-cog"></i></span><span class="pc-mtext">Stripe configuration</span></a>
                </li>
