                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="row align-items-center m-l-0">
                                <div class="col-sm-6 text-left">
                                    <button type="button" class="btn  btn-icon btn-outline-danger" onclick="delete_('<?=site_url('admin/delete/coupon/coupons/'.$coupon['id'])?>')"><i class="feather icon-trash-2"></i></button>
                                    <button type="button" class="btn  btn-icon btn-outline-primary" onclick="edit('<?=$coupon['id']?>','<?=site_url('admin/edit/coupon/'.$coupon['id'])?>')"><i class="feather icon-eye"></i></button>
                                </div>
    ...
    <div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <?=form_open_multipart('admin/insert/coupon/coupons')?>
