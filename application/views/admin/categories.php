									...
									<?php foreach ($all_category as $cat) { ?>
										...
										<tr>
											...
											<td class="table-action">
												<a href="javascript:void(0)" class="btn btn-icon btn-outline-danger" onclick="delete_('<?=site_url('admin/delete/categories/categories/'.$cat['id'])?>')"><i class="feather icon-trash-2"></i></a>
											</td>
										</tr>
									<?php } ?>
								<?php } ?>
