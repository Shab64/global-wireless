...
<div class="pc-container">
	<div class="pcoded-content">
			...
			<div class="page-block">
				<div class="row align-items-center">
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="../employee/index.php">Home</a></li>
		...
		<!-- [ breadcrumb ] end -->
		<!-- [ Main Content ] start -->
		<?= form_open('employee/insert/plans/plan'); ?>
...
<div class="modal" tabindex="-1" role="dialog" id="editPriceModal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form method="POST" action="<?= base_url('employee/updatePlanPrice') ?>">
...
<script type="text/javascript">
	...
	function planAction(switchID, planID) {
		...
		$.post('<?= base_url('employee/planAction/') ?>' + isChecked, {
			planID
		}, function(e) {
			if (e == "active") {
