                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="overlay-edit">
                                                <button type="button" class="btn btn-icon btn-danger" onclick="delete_('<?=site_url('employee/delete/user/employees/'.$users['id'])?>')"><i class="feather icon-trash-2"></i></button>
                                                <button type="button" class="btn btn-icon btn-warning" onclick="edit(<?=$users['id']?>,'<?=site_url('employee/edit/user')?>')"><i class="feather icon-edit"></i></button>
    ...
    <div class="modal fade" id="modal-report" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <?=form_open_multipart('employee/insert/user/employees')?>
