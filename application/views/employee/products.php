                                ...
                                <table id="report-table" class="table mb-0">
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            <img src="<?=(!empty($product['image'])) ? base_url('uploads/'.$img[0]) : "https://thedailytouristbd.com/uploads/no_image.jpg"?>" alt="contact-img" title="contact-img" style="width: 100px;height: 58px;" class="rounded mr-3"  />
                                        </td>
                                        <td class="align-middle">
											<?=$product['title']?>
                                        </td>
...
<!--                                            <a href="product-details.php" class="btn btn-icon btn-outline-primary"><i class="feather icon-eye"></i></a>-->
                                            <a href="<?=site_url('employee/view/add-product/'.$product['id'])?>" class="btn btn-icon btn-outline-success" ><i class="feather icon-edit"></i></a>
                                            <a href="javascript:void(0)" class="btn btn-icon btn-outline-danger" onclick="delete_('<?=site_url('employee/delete/products/products/'.$product['id'])?>')"><i class="feather icon-trash-2"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    <?php } ?>
