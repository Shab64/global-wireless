...
<head>
	...
	<title>Gwidata -employee Panel</title>
    ...
    <!--    toast-->
    <link href="<?=base_url()?>assets/css/toast.min.css" rel="stylesheet" type="text/css" />
		...
		<div class="card">
			<div class="row align-items-stretch text-center">
				<div class="col-md-6 img-card-side">
					<img src="<?=base_url()?>assets/images/auth/auth-side1.jpg" alt="" class="img-fluid">
...
<!--						    <img src="assets/images/logo-dark.svg" alt="" class="img-fluid">-->
				...
				<div class="col-md-6">
                    <form class="" action="<?=site_url('employee/do_login')?>" method="post">
					<div class="card-body">
						<div class="text-left">
							<h4 class="mb-3 f-w-600">Welcome to <span class="text-primary">Gwidata</span></h4>
...
<!--									<a href="#!" class="text-primary"><span>Forgot Password?</span></a>-->
								...
								<div class="custom-control custom-checkbox d-inline-block">
									<input type="checkbox" value="on" name="remember_me" class="custom-control-input input-primary" id="customCheckdefh2" checked="">
...
<?php
$popUp = $this->session->flashdata('error_login');
if(isset($popUp)) { ?>
    <script>
