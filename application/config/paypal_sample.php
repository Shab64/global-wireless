 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'shahab64_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '
92ZU7PJHUESRCZ8S' : 'PRODUCTION_PASSWORD_GOES_HERE';

$config['APISignature'] = $config['Sandbox'] ? 'AM1OY7f.wVAMpqj4R7Q.fRlmLhyXA5nI8gvECECn1Lngpyg51qwLTXr7
' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'shahab64@email.com';
